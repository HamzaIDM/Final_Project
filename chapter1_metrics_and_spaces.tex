...
$\sum_{i=1}^{k}|a_{i}|.|b_{i}| \le (\sum_{i=1}^{k}|a_{i}|^{p})^{\frac{1}{p}}(\sum_{i=1}^{k}|b_{i}|^{q})^{\frac{1}{q}}$.
...
This means $|f_n(x) - f(x)| \to 0$ as $n \to \infty$.
...
This means $\sup_{x \in X}|f_n - f| \to 0$ as $n \to \infty$.
